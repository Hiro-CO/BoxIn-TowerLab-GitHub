...
namespace Playmove
{
    public class SoundControlVolumeBar : PYButton, IDragHandler
    {
        ...
        {
            PlaytableWin32.Instance.SetVolume(((int)(SoundControlButton.Instance.Volume * 100)));
        }
        ...
        {
            SetMarker(Camera.main.ScreenToWorldPoint(Input.mousePosition + Vector3.forward * 31).y);
