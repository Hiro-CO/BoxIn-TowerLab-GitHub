...
namespace Playmove
{
    public class PYDrag : UIBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
    {
        ...
        public void OnBeginDrag(PointerEventData eventData)
        {
            ...
            _direction = eventData.pointerCurrentRaycast.worldPosition;
        ...
        public virtual void OnDrag(PointerEventData eventData)
        {
            ...
            RightLeft = (Direction)((Vector2)eventData.pointerCurrentRaycast.worldPosition - _direction).normalized.x;
            UpDown = (Direction)((Vector2)eventData.pointerCurrentRaycast.worldPosition - _direction).normalized.y;
